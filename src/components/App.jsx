...
{isError === true ? <ErrorImg errorImg={img} /> : images.length > 0 && <ImageGallery allImages={images} onToggleModal={this.toggleModal} />}
{loading === true ? (
<MagnifyingGlass
         visible={true}
         height="80"
         ...
         color="#354391"
       />
) : images.length > 0 && <Button text="Load more" type="button" loadMoreImages={this.loadMoreImages} />}
{isModalOpen && <Modal data={largeImageData} onToggleModal={this.toggleModal} />}
